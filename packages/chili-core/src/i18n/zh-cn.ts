...
export default {
    ...
    translation: {
        ...
        "command.annotation.start": "启动标注",
        "command.annotation.stop": "停止标注",
        "command.annotation.create": "创建标注",
        "command.annotation.delete": "删除标注",
        "command.annotation.validate": "验证标注",
        ...
        "annotation.validate": "验证标注",
        "annotation.clear": "清除所有",
        "annotation.export.aagnet": "导出AAGNet",
        "annotation.export.mftrcad": "导出MFTRCAD",
        ...
        "ribbon.group.3d": "3D",
        "ribbon.group.act": "场景",
        "ribbon.group.annotation.main": "标注",
        "ribbon.group.annotation.validate": "验证",
        "ribbon.group.annotation.export": "导出",
