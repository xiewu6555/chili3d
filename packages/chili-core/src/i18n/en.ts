...
export default {
    ...
    translation: {
        ...
        "command.annotation.start": "Start Annotation",
        "command.annotation.stop": "Stop Annotation",
        "command.annotation.create": "Create Annotation",
        "command.annotation.delete": "Delete Annotation",
        "command.annotation.validate": "Validate All",
        ...
        "annotation.validate": "Validate All",
        "annotation.clear": "Clear All",
        "annotation.export.aagnet": "Export AAGNet",
        "annotation.export.mftrcad": "Export MFTRCAD",
        ...
        "ribbon.group.annotation.main": "Annotation",
        "ribbon.group.annotation.validate": "Validation",
        "ribbon.group.annotation.export": "Export",
